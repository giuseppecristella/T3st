...
public partial class Blog : System.Web.UI.Page
{
  ...
  private static void CreateQuotePost(DataRowView itemRow, ListViewDataItem item)
  {
    ...
    var post_title = (HtmlGenericControl) item.FindControl("post_title");
    var post_meta = (HtmlGenericControl) item.FindControl("post_meta");
    var post_content = (HtmlGenericControl) item.FindControl("post_content");
    post_title.Visible = false;
    post_meta.Visible = false;
    post_content.Attributes["Class"] = "post-content quote";
