...
public partial class AddModProgetto : System.Web.UI.Page
{
  protected void Page_Load(object sender, EventArgs e)
  {
    ...
    if (idNews != null)
    {
      ...
      if ((txtProgetto.Text == ""))
      {
        ...
        txtDescBreve.Text = dtNews.Rows[0]["DescrizioneENG"].ToString();
    ...
    try
    {
      ...
      int idNews = Convert.ToInt32(taNews.InsertQuery(
          ...
          CKEditorControlResponsabile.Text,
           "1",//ddlTipo.SelectedItem.Value,
          urlFotoHome,
          allegati,
          txtVideo.Text,
          "_dummy_text",//"_dummy_titoloENG",
          txtTelRef.Text,//"_dummy_autoreENG", 
          txtDescBreve.Text,//"_dummy_descENG",
  ...
  protected void BtnGalleryArt_Click(object sender, EventArgs e)
  {
    if (!String.IsNullOrEmpty(Request.QueryString["ID"]))
    {
      ...
      {
        albumID = Convert.ToInt32(taAlbums.InsertAlbumRetID(caption, true, idNews, 2));
      ...
      else
      {
        ...
        {
          albumID = System.Convert.ToInt32(taAlbums.InsertAlbumRetID(txtProgetto.Text, true, idNews, 2));
