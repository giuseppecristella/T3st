<%@ Page Language="C#" MasterPageFile="~/Admin/AdminMaster.master" AutoEventWireup="true"
    CodeFile="ManageMAGAZINE.aspx.cs" Inherits="ManageProgetti" %>
...
<asp:Content ID="ContentBody" runat="server" ContentPlaceHolderID="cphAdminBody">
    ...
    <asp:ObjectDataSource ID="ObjectDataSource1" runat="server" OldValuesParameterFormatString="original_{0}"
        ...
        <SelectParameters>
            <asp:QueryStringParameter DefaultValue="5" Name="Tipo" QueryStringField="idTipo"
                Type="String" />
        </SelectParameters>
        <InsertParameters>
            <asp:Parameter Name="Fonte" Type="String" />
                ...
                <div class="span12">
                    ...
                    <div class="form-actions">
                        <asp:LinkButton ID="Nuovo" runat="server" Text="Aggiungi" CssClass="btn blue"
                            OnClick="Nuovo_Click"> <i class="icon-plus"></i> Nuovo Magazine
                        </asp:LinkButton>
                    </div>
