<%@ Page Language="C#" MasterPageFile="~/Admin/AdminMaster.master" AutoEventWireup="true"
    CodeFile="ManageData.aspx.cs" Inherits="ManageData" %>
...
<asp:Content ID="ContentBody" runat="server" ContentPlaceHolderID="cphAdminBody">
    ...
    <asp:ObjectDataSource ID="ObjectDataSource1" runat="server" OldValuesParameterFormatString="original_{0}"
        ...
        <SelectParameters>
            <asp:QueryStringParameter DefaultValue="0" Name="Tipo" QueryStringField="idTipo"
                Type="String" />
        </SelectParameters>
        <InsertParameters>
            <asp:Parameter Name="Fonte" Type="String" />
            ...
            <div class="row-fluid">
                <div class="span12">
                    ...
                    <div class="form-actions">
                        <asp:LinkButton ID="Button1" runat="server" CssClass="btn blue"
                            OnClick="Nuovo_Click">
                    <i class="icon-plus"></i> Nuova News
                        </asp:LinkButton>
                    </div>
                                    ...
                                    <asp:ListView ID="ListViewNews" runat="server" DataKeyNames="News_ID" DataSourceID="ObjectDataSource1"
                                        ...
                                        <EmptyDataTemplate>
                                            <div class="notification note-info">
                                                <p>
                                                    <strong>WARNING:</strong> no news available.
                                                </p>
                                            </div>
                                        </EmptyDataTemplate>
                                        <LayoutTemplate>
            ...
            <div class="row-fluid">
                <div class="span-12">
                    <div class="pagination pagination-small">
                        <asp:DataPager runat="server" ID="pager" PagedControlID="ListViewNews" PageSize="9">
                            <Fields>
