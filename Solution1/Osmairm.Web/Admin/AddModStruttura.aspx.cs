...
public partial class AddModStruttura : System.Web.UI.Page
{
  protected void Page_Load(object sender, EventArgs e)
  {
    ...
    if (idNews != null)
    {
      ...
      if ((txtSede.Text == ""))
      {
        ...
        News_ID.Text = idNews;
        txtSede.Text = dtNews.Rows[0]["Titolo"].ToString();
        ...
        CKEditorControlIndirizzo.Text = dtNews.Rows[0]["Descrizione"].ToString();
        txtReferente.Text = dtNews.Rows[0]["TitoloENG"].ToString();
    ...
    {
      if (txtSede.Text == "") //si tratta del pageload di una nuova news
      {
        //ddlTipo.SelectedValue = (string)Session["ddlTipo"];
  ...
  protected void ButtonInsert_Click(object sender, EventArgs e)
  {
    ...
    try
    {
      ...
      DataSetVepAdminTableAdapters.NewsTableAdapter taNews = new DataSetVepAdminTableAdapters.NewsTableAdapter();
      txtMappa.Text += "&output=embed&iframe=true&width=100%&height=100%";
      ...
      int idNews = Convert.ToInt32(taNews.InsertQuery(
          ...
          System.DateTime.Now,
          false,
          CKEditorControlIndirizzo.Text,
           "21",//ddlTipo.SelectedItem.Value,
          urlFotoHome,
          allegati,
          txtVideo.Text,
          txtReferente.Text,//"_dummy_titoloENG",
      ...
      Session["CaptionAlbumNews"] = txtSede.Text;
      News_ID.Text = idNews.ToString();
      //Session["ddlTipo"] = ddlTipo.SelectedValue;
      //ddlTipo.Enabled = false;
      Response.Redirect("~/Admin/ManageStrutture.aspx");
    }
    catch (Exception ex)
    {
  ...
  protected void ButtonAgg_Click(object sender, EventArgs e)
  {
    ...
    if (!txtMappa.Text.Contains("output=embed"))
    {
      txtMappa.Text += "&output=embed&iframe=true&width=100%&height=100%";
    }
    txtVideo.Text = Utility.NormalizeYouTubeVideoEmbeddedHtml(txtVideo.Text);
  ...
  protected void BtnGalleryArt_Click(object sender, EventArgs e)
  {
    ...
    if (idNews != 0)
    {
      ...
      else
      {
        ...
        {
          albumID = System.Convert.ToInt32(taAlbums.InsertAlbumRetID(txtSede.Text, true, idNews, 1));
