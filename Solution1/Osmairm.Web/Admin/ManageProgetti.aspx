<%@ Page Language="C#" MasterPageFile="~/Admin/AdminMaster.master" AutoEventWireup="true"
    CodeFile="ManageProgetti.aspx.cs" Inherits="ManageProgetti" %>
...
<asp:Content ID="ContentMenu" runat="server" ContentPlaceHolderID="cphAdminMenu">
    ...
    <li class="active"><a href="ManageProgetti.aspx">PROGETTI</a></li>
...
<asp:Content ID="ContentBody" runat="server" ContentPlaceHolderID="cphAdminBody">
    ...
    <asp:ObjectDataSource ID="ObjectDataSource1" runat="server" OldValuesParameterFormatString="original_{0}"
        ...
        <SelectParameters>
            <asp:QueryStringParameter DefaultValue="1" Name="Tipo" QueryStringField="idTipo"
                Type="String" />
        </SelectParameters>
        <InsertParameters>
            <asp:Parameter Name="Fonte" Type="String" />
        ...
        <div class="container-fluid">
            ...
            <div class="row-fluid">
                <div class="span12">
                    ...
                    <h3 class="page-title">Gestione Progetti <small>Osmairm</small>
                    </h3>
                    <div class="form-actions">
                        <asp:LinkButton ID="Nuovo" runat="server" Text="Aggiungi" CssClass="btn blue"
                            OnClick="Nuovo_Click"> <i class="icon-plus"></i> Nuovo Progetto
                        </asp:LinkButton>
                    </div>
                                    ...
                                    <asp:ListView ID="ListViewNews" runat="server" DataKeyNames="News_ID" DataSourceID="ObjectDataSource1"
                                        ...
                                        <ItemTemplate>
                                            <tr>
                                                ...
                                                <td>
                                                    <%#Eval("Titolo") %> <%--nome Progetto--%>
                                                </td>
                                                <td>
                                                    <%# Eval("TestoEng") %> <%--sede progetto--%>
                                                </td>
                                                <td>
                                                    <%--<%# Web.BaseFramework.Utility.CleanHtmlString(Eval("Descrizione").ToString())%> <%--responsabile di progetto--%>--%>
                                                </td>
                                                <%-- <%# Eval("TitoloENG") %>  <%# Eval("AutoreENG") %>   <%# Eval("DescrizioneENG") %>--%>
                                                <td>
                                                    <p>
