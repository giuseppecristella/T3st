  ...
  <asp:Content ID="Content4" ContentPlaceHolderID="cphMain" runat="Server">
    <div class="content">
        <div id="inner-content" class="post-single">
            ...
            <asp:Repeater runat="server" OnItemDataBound="rptNews_OnItemDataBound" ID="rptNews">
                <ItemTemplate>
                    <div class="post">
                        <div class="post-meta">
                            <h2 class="title">
                            ...
                            <ul>
                                ...
                                <li><%--<span>on</span>--%>
                                    ...
                                    <%# System.Globalization.DateTimeFormatInfo.CurrentInfo.GetMonthName(System.Convert.ToDateTime(Eval("Data").ToString()).Month)   %></li>
                                <%-- <li><span>with</span> <a href="#">9 comments</a></li>--%>
                            </ul>
                            <div runat="server" id="divNewsTag" class="tags">
                            </div>
                            <!--END POST-INFO-->
                        </div>
                        <!--END POST-META-->
                        <div class="post-content">
                            ...
                            <div runat="server" id="divFoto" visible="false" class="post-media">
                                ...
                                <%--    <a href="<%= Utility.GetAbsoluteUrl() %>/<%#Eval("UrlFotoHome") %>" rel="prettyPhoto" class="info" title='<%# Utility.GetStringTransFromDB(Eval("Titolo").ToString(), Eval("TitoloENG").ToString(),Eval("TitoloTED").ToString(), System.Threading.Thread.CurrentThread).ToString()%>'>
                                    Zoom</a>--%>
                            </div>
                                            ...
                                            <ItemTemplate>
                                                <li>
                                                    ...
                                                    <a href="Handler.ashx?PhotoID=<%# Eval("PhotoID") %>.jpg&W_=620&H_=415" rel="prettyPhoto[gallery]"
                                                        title='<%# Utility.GetStringTransFromDB(Eval("Titolo").ToString(), Eval("TitoloENG").ToString(),Eval("TitoloTED").ToString(), System.Threading.Thread.CurrentThread) %> '></a></li>
                                            </ItemTemplate>
                                        </asp:Repeater>
                                    </ul>
                                </div>
        ...
        <div class="border-radius" id="sidebar">
            ...
            <div style="padding-left: 10px;" class="widget">
                ...
                <ul class="archive">
                    <asp:Repeater OnItemDataBound="rptArchivio_OnItemDataBound" runat="server" ID="rptArchivio">
                        <ItemTemplate>
                        </ItemTemplate>
                    </asp:Repeater>
                </ul>
